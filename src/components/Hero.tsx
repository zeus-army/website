...
const ZeusEmoji = styled(motion.div)`
  ...
  &::after {
    ...
    animation: rainbowTongue 3s ease-in-out infinite;
  }
  
  @keyframes rainbowTongue {
    0%, 100% { filter: hue-rotate(0deg); transform: translateX(-50%) scaleX(1); }
    50% { filter: hue-rotate(360deg); transform: translateX(-50%) scaleX(1.2); }
  }
`;
